...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#paramInEnsure").click(function(){
			...
			t_data = t_data.replace(/\"{/g, "{").replace(/\"\[/g, "\[").replace(/\]\"/g, "\]").replace(/}\"/g, "}");
															...
															<div class="" role="tab" id="headingparamIn">
																<a class="collapsed" data-toggle="collapse" data-parent="#paramIn" href="#paramInBody" aria-expanded="false" aria-controls="paramInBody">
																	<div class="input-group">
																		...
																		<input type="text"  class="form-control" placeholder='{"paramIn": [{"paramName":"value1","paramDescription":"value2","paramType":"value3","paramDefault":"value4","isNeeded":"value5"},{}]}' id="paramInValue" name="paramInValue">
																	</div>
																</a>
															</div>
																		...
																		<tbody>
																			<tr class="active">
																				...
																				<td width="70%" align="right">
																					<input type="text" class="form-control" id="paramInValueJson" name="paramInValueJson">
