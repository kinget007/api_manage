        ...
        $(document).ready(function () {
            ...
            $("#URLPath").blur(function () {
                ...
                if (urlParam != "") {
                    ...
                    jsonBodyURLCurrent = ("{\"" + urlParam.replace(/\=/g, "*url*1\":\"").replace(/&/g, "\",\"") + "\"}").replace(/\"\"/g, "\"").replace(/\"{/g, "{").replace(/\"\[/g, "\[").replace(/\]\"/g, "\]").replace(/}\"/g, "}");
                    ;
                    jsonBodyURLCurrent2 = jsonBodyURLCurrent;
//                    alert(jsonBodyURLCurrent);
//                    alert(jsonBodyURLCurrent2);
                }
            ...
            $("#paramInEnsure").click(function () {
                ...
                for (var key in jsonParamIn) {
                    if (typeof(jsonParamIn[key]) == "object") {
                        jsonParamIn[key] = JSON.stringify(jsonParamIn[key]);
                    }
                    if (key.split("*")[2] == 1) {
            ...
            $("#jsonPost").blur(function () {
                ...
                if ($("#jsonPost").val() != "") {
                    ...
                    for (var key in jsonPostParamIn) {
                        ...
                        count++;
                        if (typeof(jsonPostParamIn[key]) == "object") {
                            jsonPostParamIn[key] = JSON.stringify(jsonPostParamIn[key]);
                        }
                        jsonStringTr = jsonStringTr +
                                "<tr class=\"success\">" +
                                "<td><input type=\"checkbox\" checked=\"checked\"></td>" +
            ...
            $("#submitbtn").click(function () {
                ...
                for (key in resultJsons) {
                    ...
                    if (typeof(resultJsons[key]) == "string") {
                        values = resultJsons[key].split(",");
                    }
                    else{
                        values.push(resultJsons[key]);
                    }
                    if (resultArray.length == 0) {
                        for (var i = 0; i < values.length; i++) {
                            if (typeof(values[i]) == "object") {
//                                values[i] = JSON.stringify(values[i]);
//                                alert("shuju"+JSON.stringify(values[i]));
//                                resultArray[i] = "\"" + key + "\":" + "[" + JSON.stringify(values[i]) + "],";
                                resultArray[i] = "\"" + key + "\":"  + JSON.stringify(values[i]) + ",";
                            }
                            else {
                        ...
                        for (var j = 0; j < values.length; j++) {
                            for (var k = 0; k < resultArraylength; k++) {
                                if (typeof(values[j]) == "object") {
                                    resultArray[resultArraylength * j + k] = resultArrayStart[k] + "\"" + key + "\":" + JSON.stringify(values[j]) + ",";
                                ...
                                resultArray[resultArraylength * j + k] = resultArray[resultArraylength * j + k].replace(/\"{/g, "{").replace(/\"\[/g, "\[").replace(/\]\"/g, "\]").replace(/}\"/g, "}");
...
//                    alert(basePath + "/api_manage/ApiToolsServlet?URLPath=" + encodeURIComponent(urlPath) + "&jsonBody=" + encodeURIComponent(jsonBody) + "&headIn=" + encodeURIComponent(headIn) + "&urlMethod=" + urlMethod);

//                   $.post(basePath + "/api_manage/ApiToolsServlet",
//                           {"jsonBody":encodeURIComponent(jsonBody),"headIn":encodeURIComponent(headIn),"urlMethod":urlMethod,"URLPath":encodeURIComponent(urlPath)}       ,"json",
//                    function(data,status){
//                        alert(data);
//                    });

                    $.ajax({
                        url:basePath + "/api_manage/ApiToolsServlet",
                        data:{"jsonBody":encodeURIComponent(jsonBody),"headIn":encodeURIComponent(headIn),"urlMethod":urlMethod,"URLPath":encodeURIComponent(urlPath)},
                        dataType:"json",
                        type:"post",
                        success:function(data){
                            var resultInfo = JSON.stringify(data.result);
                            if (resultInfo.toLowerCase().indexOf("\"code\"" + ":" + "\"success\"") == -1) {
...
<form>
                    ...
                    <div class="panel-heading">
                        <table width="100%">
                            <tr>
                                ...
                                <td align="right"><a href="apiTools.jsp">
                                    <button type="button" class="btn btn-xs btn-info">清空数据</button>
                                </a></td>
                            </tr>
                        </table>
                    </div>
                    <div class="panel-body">
                        <div id="protocol_host_path">
                            <table width="100%">
                                <tbody>
                                <tr>
                                    <td><input name="URLPath" type="text" id="URLPath" style="width:100%;"
                                               placeholder="http://api.test.com/path?param1=value1&param2=value2"></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
        ...
        <div class="row clearfix">
            <div class="col-md-6 column">
                <div class="panel panel-default">
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    <button type="button" class="btn btn-xs btn-info" data-toggle="modal"
                                            data-target="#myModal" id="paramInEnsure">参数修改
                                    </button>
                                </td>
                            </tr>
                        </table>
                    ...
                    <%--<div class="panel-body">--%>
                    <%--<input name="jsonBody" type="text" class="form-control" style="width:100%;" id="jsonBody"--%>
                    <%--placeholder='{"param1":"value1","param2":"value2","param3":"value3"}'>--%>
                    <%--<input name="jsonBodyURLCurrent" type="text" style="width:100%;" id="jsonBodyURLCurrent">--%>
                    <%--<input name="jsonBodyALL" type="text" style="width:100%;" id="jsonBodyALL">--%>
                    <%--<input name="jsonBodyResult" type="text" style="width:100%;" id="jsonBodyResult">--%>
                    <%--</div>--%>
                    <div class="panel-body">
                        <input name="jsonBody" type="text" class="form-control" style="width:100%;" id="jsonBody"
                               placeholder='{"param1":"value1","param2":"value2","param3":"value3"}'>
                        <input name="jsonBodyURLCurrent" type="text" style="width:100%;display: none"
                               id="jsonBodyURLCurrent">
            ...
            <div class="col-md-6 column">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <input name="headIn" id="headIn" type="text" style="width:100%;"
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>请求方法</td>
                                        <td>
                                            <label class="radio-inline"><input type="radio" name="urlMethod"
                                                                               id="urlMethod" value="get"
                                                                               checked="checked"/>get </label>
                                            <label class="radio-inline"><input type="radio" name="urlMethod"
                                                                               id="urlMethod" value="post"/>post</label>
                                        </td>
                                    </tr>
    ...
    <!-- Modal alert-->
    <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
         aria-hidden="true" id="alertModal2">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="overflow:auto;">
                    <table class="table table-bordered" id="jsonPostTr" width="100%">
                        <tbody>
                        <tr>
                            <td width="100%"><input name="jsonPost" width="300px" class="form-control" id="jsonPost"
                                                    placeholder='POST BODY {"param1":"value1","param2":"value2","param3":"value3"}'>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" data-dismiss="modal" id="changeParamIn">Save changes
                    </button>
                </div>
            </div>
        </div>
