...
//    if(session.getAttribute("name")==null){response.sendRedirect("/api_manage/login.jsp");}
//	if(session.getAttribute("name")==null || session.getAttribute("uid")==null){response.sendRedirect("/api_manage/login.jsp");}
%>
